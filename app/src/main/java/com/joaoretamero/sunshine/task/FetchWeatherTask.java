package com.joaoretamero.sunshine.task;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                ...
                mContext.getString(R.string.pref_unit_metric_key));

        if (unitType.equals(mContext.getString(R.string.pref_unit_imperial_key))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_unit_metric_key))) {
